    ...
    <section id="hero" class="hero">
      ...
      >
        <div
          ...
          style="
            background-image: url(src/assets/images/hero-carousel/hero-carousel-1.jpg);
          "
        ></div>
        <div
          class="carousel-item"
          style="
            background-image: url(src/assets/images/hero-carousel/hero-carousel-2.jpg);
          "
        ></div>
        <div
          class="carousel-item"
          style="
            background-image: url(src/assets/images/hero-carousel/hero-carousel-3.jpg);
          "
        ></div>
        <div
          class="carousel-item"
          style="
            background-image: url(src/assets/images/hero-carousel/hero-carousel-4.jpg);
          "
        ></div>
        <div
          class="carousel-item"
          style="
            background-image: url(src/assets/images/hero-carousel/hero-carousel-5.jpg);
          "
        ></div>
                ...
                <div class="row">
                  <div class="col-xl-5">
                    <div
                      class="card-bg"
                      style="
                        background-image: url(src/assets/images/constructions-1.jpg);
                      "
                    ></div>
                  </div>
                ...
                <div class="row">
                  <div class="col-xl-5">
                    <div
                      class="card-bg"
                      style="
                        background-image: url(src/assets/images/constructions-2.jpg);
                      "
                    ></div>
                  </div>
                  <div class="col-xl-7 d-flex align-items-center">
                ...
                <div class="row">
                  <div class="col-xl-5">
                    <div
                      class="card-bg"
                      style="
                        background-image: url(src/assets/images/constructions-3.jpg);
                      "
                    ></div>
                  </div>
                  <div class="col-xl-7 d-flex align-items-center">
                ...
                <div class="row">
                  <div class="col-xl-5">
                    <div
                      class="card-bg"
                      style="
                        background-image: url(src/assets/images/constructions-4.jpg);
                      "
                    ></div>
                  </div>
                  <div class="col-xl-7 d-flex align-items-center">
        ...
        <div class="container" data-aos="fade-up">
          <div class="row justify-content-around gy-4">
            <div
              ...
              style="background-image: url(src/assets/images/alt-services.jpg)"
              data-aos="zoom-in"
              data-aos-delay="100"
            ></div>
          ...
          <div class="tab-content">
            <div class="tab-pane active show" id="tab-1">
              <div class="row">
                ...
                >
                  <img
                    src="/src/assets/images/features-1.jpg"
                    alt=""
                    class="img-fluid"
                  />
                </div>
            ...
            >
              <div class="col-lg-4 col-md-6 portfolio-item filter-remodeling">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/remodeling-1.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <a
                      href="/src/assets/images/projects/remodeling-1.jpg"
                      title="Remodeling 1"
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-construction">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/construction-1.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/construction-1.jpg"
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-repairs">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/repairs-1.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/repairs-1.jpg"
                      title="Repairs 1"
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-design">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/design-1.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/design-1.jpg"
                      title="Repairs 1"
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-remodeling">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/remodeling-2.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/remodeling-2.jpg"
                      title="Remodeling 2"
                      data-gallery="portfolio-gallery-remodeling"
                      class="glightbox preview-link"
                      ><i class="bi bi-zoom-in"></i
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-construction">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/construction-2.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/construction-2.jpg"
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-repairs">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/repairs-2.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/repairs-2.jpg"
                      title="Repairs 2"
                      data-gallery="portfolio-gallery-repairs"
                      class="glightbox preview-link"
                      ><i class="bi bi-zoom-in"></i
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-design">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/design-2.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/design-2.jpg"
                      title="Repairs 2"
                      data-gallery="portfolio-gallery-book"
                      class="glightbox preview-link"
                      ><i class="bi bi-zoom-in"></i
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-remodeling">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/remodeling-3.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/remodeling-3.jpg"
                      title="Remodeling 3"
                      data-gallery="portfolio-gallery-remodeling"
                      class="glightbox preview-link"
                      ><i class="bi bi-zoom-in"></i
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-construction">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/construction-3.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/construction-3.jpg"
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-repairs">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/repairs-3.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/repairs-3.jpg"
                      title="Repairs 2"
                      data-gallery="portfolio-gallery-repairs"
                      class="glightbox preview-link"
                      ><i class="bi bi-zoom-in"></i
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-design">
                <div class="portfolio-content h-100">
                  <img
                    src="/src/assets/images/projects/design-3.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="portfolio-info">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                    <a
                      href="/src/assets/images/projects/design-3.jpg"
                      title="Repairs 3"
                      data-gallery="portfolio-gallery-book"
                      class="glightbox preview-link"
                      ><i class="bi bi-zoom-in"></i
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
                    <img
                      src="/src/assets/images/testimonials/testimonials-1.jpg"
              ...
              <div class="swiper-slide">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
                    <img
                      src="/src/assets/images/testimonials/testimonials-2.jpg"
                      class="testimonial-img"
                      alt=""
                    />
                    <h3>Sara Wilsson</h3>
              ...
              <div class="swiper-slide">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
                    <img
                      src="/src/assets/images/testimonials/testimonials-3.jpg"
                      class="testimonial-img"
                      alt=""
                    />
                    <h3>Jena Karlis</h3>
              ...
              <div class="swiper-slide">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
                    <img
                      src="/src/assets/images/testimonials/testimonials-4.jpg"
                      class="testimonial-img"
                      alt=""
                    />
                    <h3>Matt Brandon</h3>
              ...
              <div class="swiper-slide">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
                    <img
                      src="/src/assets/images/testimonials/testimonials-5.jpg"
                      class="testimonial-img"
                      alt=""
                    />
                    <h3>John Larson</h3>
